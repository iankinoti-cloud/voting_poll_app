      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <motion.button
            type="submit"
            disabled={loading}
            className="w-full py-3 rounded-xl font-semibold text-sm tracking-wide transition-opacity"
        ...
        <motion.button
          ...
          disabled={loading}
          className="w-full py-3 rounded-xl font-semibold text-sm flex items-center justify-center gap-3 transition-opacity"
        ...
        <p className="mt-6 text-center text-sm" style={{ color: '#8a7a6a' }}>
          No account?{' '}
          <Link to="/signup" className="font-semibold underline" style={{ color: '#c8b89a' }}>
            Sign up
          </Link>
        </p>
      </motion.div>
